...
# Terminal 1 — Postgres
pnpm db:up
pnpm --filter @outbreak/api db:migrate deploy
pnpm --filter @outbreak/api db:seed

# Terminal 2 — API
pnpm --filter @outbreak/api dev

# Terminal 3 — Web
pnpm --filter @outbreak/web dev
```
